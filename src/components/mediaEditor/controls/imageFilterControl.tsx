...
const IMAGE_FILTER_CONTROLS_CONFIG = [{
  name: i18n('ImageEditor.EnhanceControl.Enhance'),
  ...
  name: i18n('ImageEditor.EnhanceControl.Brightness'),
  ...
  name: i18n('ImageEditor.EnhanceControl.Contrast'),
  ...
  name: i18n('ImageEditor.EnhanceControl.Saturation'),
  ...
  name: i18n('ImageEditor.EnhanceControl.Warmth'),
  ...
  name: i18n('ImageEditor.EnhanceControl.Fade'),
  ...
  name: i18n('ImageEditor.EnhanceControl.Highlights'),
  ...
  name: i18n('ImageEditor.EnhanceControl.Shadows'),
  ...
  name: i18n('ImageEditor.EnhanceControl.Vignette'),
  ...
  name: i18n('ImageEditor.EnhanceControl.Grain'),
  ...
  name: i18n('ImageEditor.EnhanceControl.Sharpen'),
...
export function ImageFilterControl(props: ImageFilterControlProps): JSX.Element {
  return (
    <div class="image-editor__image-control">
